...
class ShowF2LCommand extends Command {
    constructor(client) {
        super(client, {
            name: 'showf2l',
            aliases: ['f2l', 'f2lcase'],
            group: 'images',
            memberName: 'showf2l',
            description: 'Takes in a set of turns and shows the F2L case on the 3x3x3',
            examples: ["showf2l R U R' U' R U R' U' R U R' U'", "F2L R U R'"],
            args: [
                {
                    key: 'moves',
    ...
    run(msg, args) {
        ...
        let url = `http://stachu.cubing.net/v/visualcube.php?fmt=png&size=${Constants.DISPLAY_SIZE}&pzl=${givenSize}&case=${newMoves}&stage=f2l`;
